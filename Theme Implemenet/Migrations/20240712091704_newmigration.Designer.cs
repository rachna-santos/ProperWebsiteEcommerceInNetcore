...
namespace Theme_Implemenet.Migrations
{
    ...
    [Migration("20240712091704_newmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.contact", b =>
                {
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.ContactUs", b =>
                {
                    b.Property<int>("contactId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.OderStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.PaymentType", b =>
                {
                    b.Property<int>("PaymentTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Promotionmapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Promotions", b =>
                {
                    b.Property<int>("proId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Rewies", b =>
                {
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.ShoppingCarts", b =>
                {
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Signup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.contact", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.Signup", "Signup")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.ContactUs", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Inventory", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Theme_Implemenet.Models.Order", "Order_Tbl")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Theme_Implemenet.Models.ProductVeriation", "ProductVeriation")
                        .WithMany()
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Payment", b =>
                {
                    ...
                    b.HasOne("Theme_Implemenet.Models.PaymentType", "PaymentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Promotionmapping", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.Promotions", "Promotions")
                        .WithMany()
                        .HasForeignKey("proId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Theme_Implemenet.Models.Rewies", b =>
                {
                    b.HasOne("Theme_Implemenet.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Rewies")
                        .HasForeignKey("UserId");
